                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <blockquote class="blockquote">
                                <h3 class="textoNegro">Alta Usuario STI</h3>
                            </blockquote>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group flex-nowrap">
                                        ...
                                        <input type="text" class="form-control" oninput="validarCURP()"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3 position-relative" id="">
                                        ...
                                        <input type="text" autocomplete="off" class="form-control" id="correo"
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3 position-relative" id="">
                                        ...
                                        <input type="password" autocomplete="off" class="form-control"
                                            ...
                                            placeholder="CONFIRMAR" oninput="this.value = this.value.toUpperCase();">
                                    </div>
                                </div>
                            </div>
                        </div>
