...
<div class="auth-fluid">
    ...
    <div class="auth-fluid-form-box">
        <div class="align-items-center d-flex h-100">
            <div class="card-body login-box">
                ...
                <!-- Logo -->
                <div class="auth-brand text-center text-lg-start imagenLogin">

                    <a href="#" class="logo-light text-center  ">
                        <span><img src="<?php echo base_url();?>/assets/images/st4.png" alt="Logo"
                                class="img-fluid"></span>
                    </a>
                </div>

                <div class="text-center " id="txtTitulo">
                    <h2 class="mt-0" style="color: #069">Control Moodle</h2>
                ...
                <form id="login" name="login" autocomplete="off">
                    ...
                    <div class="mb-3">
                        <a href="pages-recoverpw-2.html" class="text-muted float-end"><small>Recuperar
                                contraseña</small></a>
                        <label for="contrasenia" class="form-label">Contraseña</label>
                        <input class="form-control" type="password" required="" id="contrasenia" name="contrasenia"
                            placeholder="Ingresa tu contraseña">
                    </div>

                    <div class="d-grid mb-0 text-center" id="btn_entrar" >
                        <button class="btn btn-primary" type="submit"><i class="mdi mdi-login"></i> Entrar </button>
                    </div>
               <!--      <div class="d-grid mb-0 text-center" id="btn_load" style="display">
    ...
    <div class="auth-fluid-right text-left">
        <div class="auth-user-testimonial">
            <img src="<?php echo base_url().'/assets/images/st5.png'?>" alt width="183px" height="60px">
