                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="checkbox" id="visible" disabled checked data-switch="success"
                                    name="visible" />
                                <label for="visible" data-on-label="visible" data-off-label="Off"></label>
                                <?php endif ?>
                                <?php if(isset($details[0]->visible) && $details[0]->visible == 0): ?>
                                <input type="checkbox" id="cerrado" disabled checked data-switch="warning"
                                    name="cerrado" />
                            ...
                            <div class="col-md-6">
                                <div class="mb-6 position-relative">
                                    <label for="fec_fin" class="form-label campoObligatorio">FECHA DE TERMINACION
                                        DEL
                                        CURSO</label>
                                    <input type="date" autocomplete="off" class="form-control" id="fec_fin"
                                        name="fec_fin" value="<?php echo $fec_f; ?>">
                                </div>
                            </div>
