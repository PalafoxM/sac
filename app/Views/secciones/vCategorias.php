    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Categorias Padre</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active">
                            <div class="table-responsive">
                                <table id="getCategoria" data-locale="es-MX" data-toolbar="#toolbar"
                                    ...
                                    data-url="<?=base_url("/index.php/Principal/getCategoria")?>">
                                    <thead>
                                        <tr>
                                            <th data-field="id_categoria" data-width="20" data-sortable="true">ID CATEGORIA</th>
                                            <th data-field="dsc_categoria" data-width="20" data-sortable="true">NOMBRE</th>
                                            <th data-field="activo" data-formatter="saeg.principal.formattCat" data-width="20" data-sortable="true">ACTIVO</th>

                                            <th data-field="id_participante" data-width="100" data-sortable="true"
                                                data-formatter="saeg.principal.formattCategoria" data-tooltip="true">
                                                ACCIONES</th>
                                        </tr>
                                    </thead>
                                </table>
