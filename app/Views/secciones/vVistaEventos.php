    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">VISTA GENERAL</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <h5 class="text-muted fw-normal mt-0 text-truncate" title="Campaign Sent">APROBADOS</h5>
        ...
        <div class="col-lg-6 col-xl-4">
            <div class="card">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <h5 class="text-muted fw-normal mt-0 text-truncate" title="New Leads">NO APROBADOS POR CALIFICACION</h5>
        ...
        <div class="col-lg-6 col-xl-4">
            <div class="card">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <h5 class="text-muted fw-normal mt-0 text-truncate" title="Deals">NO INGRESO</h5>
        ...
        <div class="col-lg-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title mb-1">ESTATUS</h4>
        ...
        <div class="col-lg-7">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title mb-3">CONCURRENCIA</h4>

                    <div class="chart-content-bg">
                        <div class="row text-center">
                            <div class="col-md-6">
                                <p class="text-muted mb-0 mt-3">Estudiantes</p>
        ...
        <div class="col-xl-4 col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title mb-3">CURSOS</h4>
        ...
        <div class="col-xl-4 col-lg-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title mb-4">CALIFICAIONES MAS ALTAS</h4>
...
<script src="<?= base_url('assets/js/ui/component.todo.js'); ?>"></script>
<script src="<?= base_url('assets/js/pages/demo.dashboard-crm.js'); ?>"></script>
